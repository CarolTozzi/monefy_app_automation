...
public class addExpenseTest {
    ...
    public static void addExpense(AndroidDriver<AndroidElement> driver) {
        ...
        MobileElement number5 = driver.findElementById("com.monefy.app.lite:id/buttonKeyboard5");
        number5.click();

        MobileElement addNoteField = driver.findElementById("com.monefy.app.lite:id/textViewNote");
        addNoteField.click();
        addNoteField.sendKeys("Expense");
        valueField.click();
        ...
        Assert.that(balanceField.getText().equalsIgnoreCase("Balance -$5.00"), "Expense was added correctly");
